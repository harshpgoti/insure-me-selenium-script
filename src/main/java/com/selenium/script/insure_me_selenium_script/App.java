package com.selenium.script.insure_me_selenium_script;
...
//        System.setProperty("webdriver.chrome.driver", "/nee/chromedriver_win32/chromedriver.exe");
      ...
      System.setProperty("webdriver.chrome.driver", "/usr/bin/chromedriver");
        ...
        driver.get("http://44.210.141.94:8081/contact.html");
        driver.manage().timeouts().implicitlyWait(5,TimeUnit.SECONDS);
        
        driver.findElement(By.id("inputName")).sendKeys("Harsh Goti");
        driver.findElement(By.id("inputNumber")).sendKeys("9999999999");
        driver.findElement(By.id("inputMail")).sendKeys("harshgoti@gmail.com");
